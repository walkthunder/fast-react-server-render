...
import type {ReactElement} from './libs/ReactElementType';
import type {
  ReactProvider,
  ReactConsumer,
  ReactContext,
} from './libs/ReactTypes';
import lowPriorityWarning from './libs/lowPriorityWarning';
import describeComponentFrame from './libs/describeComponentFrame';
import {ReactDebugCurrentFrame} from './libs/ReactGlobalSharedState';
import {warnAboutDeprecatedLifecycles} from './libs/ReactFeatureFlags';
import {
...
import {
  ...
  getChildNamespace,
} from './libs/DOMNamespaces';
import ReactControlledValuePropTypes from './libs/ReactControlledValuePropTypes';
import assertValidProps from './libs/assertValidProps';
import dangerousStyleValue from './libs/dangerousStyleValue';
import isCustomComponent from './libs/isCustomComponent';
import omittedCloseTags from './libs/omittedCloseTags';
import warnValidStyle from './libs/warnValidStyle';
import {validateProperties as validateARIAProperties} from './libs/ReactDOMInvalidARIAHook';
import {validateProperties as validateInputProperties} from './libs/ReactDOMNullInputValuePropHook';
import {validateProperties as validateUnknownProperties} from './libs/ReactDOMUnknownPropertyHook';
